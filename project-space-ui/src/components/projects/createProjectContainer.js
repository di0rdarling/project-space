...
import { makeStyles, Typography, Modal, Paper, Button } from '@material-ui/core';
    ...
    return (
        <Modal
            ...
            <Paper className={classes.createForm} >
                <div>
                    <Typography className={classes.createProjectText}>Create Project</Typography>
                    <div>
                    ...
                    <div>
                        <Typography className={classes.otherText}>Project Description</Typography>
                        <input
                            className={classes.input}
                            onChange={(event) => {
                                dispatch({
